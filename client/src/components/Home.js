    ...
    return (
      <Image style={styles.container} source={require('../assets/fire.jpeg')}>
        <View style={styles['logo-container']}>
          <TouchableOpacity onPress={()=> navigate('Payment',{paymentType: 'Go-Pay'})}>
          ...
          <TouchableOpacity onPress={()=> navigate('Payment',{paymentType: 'BliBli Cash'})}>
        ...
        <View style={styles['logo-container']}>
          <TouchableOpacity onPress={()=> navigate('Payment',{paymentType: 'Toko Cash'})}>
          ...
          <TouchableOpacity onPress={()=> navigate('Payment',{paymentType: 'E-Toll'})}>
